...
% StiffMatrix(LocalRows(:),LocalColumns(:)) = OP11;
% StiffMatrix(AdjacentRows(:),LocalColumns(:)) = OP12;
...
%     StiffMatrix(BottomAdjacentRows(:),LocalColumns(:)) = OP12;
...
%     StiffMatrix(UpAdjacentRows(:),LocalColumns(:)) = OP12;
end
...
TempRBRHS = zeros(obj.meshUnion.cell.Np, 1);
%> move these terms about Dirichlet boundary to the right hand side 
