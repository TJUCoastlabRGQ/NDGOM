classdef ManufacturedSolution3d < SWEBarotropic3d
    ...
    methods ( Access = protected )
        ...
        function matGetFunction(obj)
            ...
            obj.OmegaO = @(x,y,z,t)(-(sin(t/100 + x/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2) .* ...
                ( cos(t/100 + x/100)/100000 - 1/200 ) + (((z + 1).*(sin(t/100 + x/100) - 5*y - 5*x + sin(t/100 + y/100) + 2000))/1000) .* ...
                ( - (sin(t/100 + x/100).*(cos(t/100 + x/100)/1000000 - 1/2000))/2 - (cos(t/100 + x/100).*(sin(t/100 + x/100)/10000 -...
                y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/200 ) - ( -(sin(t/100 + x/100).*(z + 1).^2.*(sin(t/100 + x/100) - 5*y - 5*x + sin(t/100 + y/100) + 2000))/20000 ) .* ...
                ( cos(t/100 + x/100)/100000 - 1/200 ) - ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* ( -((z + 1).^2.*(2000*cos(t/100 + x/100) - 500*sin(t/100 + x/100) - 5*x.*cos(t/100 + x/100) - ...
                5*y.*cos(t/100 + x/100) + 2*cos(t/100 + x/100).*sin(t/100 + x/100) + cos(t/100 + x/100).*sin(t/100 + y/100)))/2000000 ) + ...
                ( -(sin(t/100 + y/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2 ) .* ( cos(t/100 + y/100)/100000 - 1/200 ) + ...
                ( ((z + 1).*(sin(t/100 + x/100) - 5*y - 5*x + sin(t/100 + y/100) + 2000))/1000 ) .* ( - (sin(t/100 + y/100).*(cos(t/100 + y/100)/1000000 - 1/2000))/2 - (cos(t/100 + y/100).*(sin(t/100 + x/100)/10000 - ...
                y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/200 ) - ( -(sin(t/100 + y/100).*(z + 1).^2.*(sin(t/100 + x/100) - 5*y - 5*x + sin(t/100 + y/100) + 2000))/20000 ) .* ...
                ( cos(t/100 + y/100)/100000 - 1/200 ) - ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* (-((z + 1).^2.*(2000*cos(t/100 + y/100) - 500*sin(t/100 + y/100) - 5.*x.*cos(t/100 + y/100) - ...
                5.*y.*cos(t/100 + y/100) + cos(t/100 + y/100).*sin(t/100 + x/100) + 2*cos(t/100 + y/100).*sin(t/100 + y/100)))/2000000);

            obj.Omega = @(x,y,z,t) -( (z + 1).*(cos(t/100 + x/100)/100000 + cos(t/100 + y/100)/100000) ) - ( -((z + 1).^2.*(sin(t/100 + x/100) - 5*y - 5*x + sin(t/100 + y/100) + 2000).*(2000*cos(t/100 + x/100) - ...
                500*sin(t/100 + x/100) - 5*x.*cos(t/100 + x/100) - 5.*y.*cos(t/100 + x/100) + 2*cos(t/100 + x/100).*sin(t/100 + x/100) + cos(t/100 + x/100).*sin(t/100 + y/100)))/2000000000 ) - ( - (sin(t/100 + x/100).*(cos(t/100 + x/100)./100000 - ...
                1/200).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2 - z.*sin(t/100 + x/100).*(cos(t/100 + x/100)/100000 - 1/200).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5) - ...
                (z.^2.*sin(t/100 + x/100).*(cos(t/100 + x/100)/100000 - 1/200).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2 ) - ( -((z + 1).^2.*(sin(t/100 + x/100) - 5*y - 5*x + sin(t/100 + y/100) + 2000).*(2000*cos(t/100 + ...
                y/100) - 500*sin(t/100 + y/100) - 5.*x.*cos(t/100 + y/100) - 5.*y.*cos(t/100 + y/100) + cos(t/100 + y/100).*sin(t/100 + x/100) + 2*cos(t/100 + y/100).*sin(t/100 + y/100)))/2000000000 ) - ( - (sin(t/100 + y/100).*(cos(t/100 + y/100)/100000 - ...
                1/200).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2 - z.*sin(t/100 + y/100).*(cos(t/100 + y/100)/100000 - 1/200).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5) - ...
                (z.^2.*sin(t/100 + y/100).*(cos(t/100 + y/100)/100000 - 1/200).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2 );

            
            obj.Os = @(x,y,z,t)(-(sin(t/100 + x/100).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2) .* ( cos(t/100 + x/100)/100000 - 1/200 ) + ...
                ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* ( - (sin(t/100 + x/100).*(cos(t/100 + x/100)/1000000 - 1/2000))/2 - (cos(t/100 + x/100).*(sin(t/100 + x/100)/10000 -...
                y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/200 ) - ( -(obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ))*obj.d.*( z + 1 ).*sin(obj.w.*(x+t)) ) .* ...
                ( cos(t/100 + x/100)/100000 - 1/200 ) - ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* ( - (cos(t/100 + x/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + ...
                sin(t/100 + y/100)/10000 + 1/5))/100 - sin(t/100 + x/100).*(cos(t/100 + x/100)/1000000 - 1/2000).*(z + 1) ) + ( -(sin(t/100 + y/100).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2 ) .* ...
                ( cos(t/100 + y/100)/100000 - 1/200 ) + ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* ( - (sin(t/100 + y/100).*(cos(t/100 + y/100)/1000000 - 1/2000))/2 - (cos(t/100 + y/100).*(sin(t/100 + x/100)/10000 - ...
                y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/200 ) - ( -(obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ))*obj.d.*( z + 1 ).*sin(obj.w.*(y+t)) ) .* ( cos(t/100 + y/100)/100000 - 1/200 ) - ...
                ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* ( - (cos(t/100 + y/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + ...
                sin(t/100 + y/100)/10000 + 1/5))/100 - sin(t/100 + y/100).*(cos(t/100 + y/100)/1000000 - 1/2000).*(z + 1) );
                                    
            obj.Continuity = @(x,y,z,t) (cos(t/100 + x/100)/100000 + cos(t/100 + y/100)/100000) + ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* (- (cos(t/100 + x/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + ...
                sin(t/100 + y/100)/10000 + 1/5))/100 - sin(t/100 + x/100).*(cos(t/100 + x/100)/1000000 - 1/2000).*(z + 1)) + ( -(obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ))*obj.d.*( z + 1 ).*sin(obj.w.*(x+t)) ) .* ...
                ( cos(t/100 + x/100)/100000 - 1/200 ) + ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* ( - (cos(t/100 + y/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + ...
                sin(t/100 + y/100)/10000 + 1/5))/100 - sin(t/100 + y/100).*(cos(t/100 + y/100)/1000000 - 1/2000).*(z + 1) ) + ( -(obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ))*obj.d.*( z + 1 ).*sin(obj.w.*(y+t)) ) .* ...
                ( cos(t/100 + y/100)/100000 - 1/200 ) + ((-(sin(t/100 + x/100).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2) .* ( cos(t/100 + x/100)/100000 - 1/200 ) + ...
                ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* ( - (sin(t/100 + x/100).*(cos(t/100 + x/100)/1000000 - 1/2000))/2 - (cos(t/100 + x/100).*(sin(t/100 + x/100)/10000 -...
                y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/200 ) - ( -(obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ))*obj.d.*( z + 1 ).*sin(obj.w.*(x+t)) ) .* ...
                ( cos(t/100 + x/100)/100000 - 1/200 ) - ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* ( - (cos(t/100 + x/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + ...
                sin(t/100 + y/100)/10000 + 1/5))/100 - sin(t/100 + x/100).*(cos(t/100 + x/100)/1000000 - 1/2000).*(z + 1) ) + ( -(sin(t/100 + y/100).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2 ) .* ...
            ...
            obj.ContinuityN= @(x,y,z,t) (cos(t/100 + x/100)/100000 + cos(t/100 + y/100)/100000) + (obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y )) .*(- (cos(t/100 + x/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + ...
                sin(t/100 + y/100)/10000 + 1/5))/100 - sin(t/100 + x/100).*(cos(t/100 + x/100)/1000000 - 1/2000).*(z + 1)) + (-(obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ))*obj.d.*( z + 1 ).*sin(obj.w.*(x+t))) .* ...
                (cos(t/100 + x/100)/100000 - 1/200) + ( obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ) ) .* (- (cos(t/100 + y/100).*(z + 1).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + ...
                sin(t/100 + y/100)/10000 + 1/5))/100 - sin(t/100 + y/100).*(cos(t/100 + y/100)/1000000 - 1/2000).*(z + 1)) + ( -(obj.e * ( sin(obj.w*(x+t)) + sin(obj.w*(y+t)) ) + 2 - 0.005*( x + y ))*obj.d.*( z + 1 ).*sin(obj.w.*(y+t)) ) .* ...
                ( cos(t/100 + y/100)/100000 - 1/200 ) + ((-(sin(t/100 + x/100).*(sin(t/100 + x/100)/10000 - y/2000 - x/2000 + sin(t/100 + y/100)/10000 + 1/5))/2) .* ( cos(t/100 + x/100)/100000 - 1/200 ) + ...
        ...
        function  matEvaluateSourceTerm(obj, fphys, time)
            ...
            Omega = obj.Omega(mesh.x, mesh.y, mesh.z, time);
            
            OmegaO = obj.OmegaO(mesh.x, mesh.y, mesh.z, time);
            
            OmegaN = obj.Ou2d( mesh.x, mesh.y, mesh.z, time) .* obj.hx( mesh.x, mesh.y, time) + ...
            ...
            Continu1  = obj.Continuity( mesh.x, mesh.y, mesh.z, time );
            Continu2  = obj.ContinuityN( mesh.x, mesh.y, mesh.z, time );
        ...
        function  [ hu, hv, Omega, h ] = matGetExactSolution( obj, x, y, z, time)
            hu = obj.h(x, y, time) .* obj.u(x, y, z, time);
            hv = obj.h(x, y, time) .* obj.v(x, y, z, time);
            h = obj.h(x, y, time);
            Omega = obj.Ou2d(x, y, z, time) .* obj.hx(x, y, time) + ...
                obj.OH(x, y, z, time) .* obj.u2dx(x, y, time) - ...
                obj.Ou(x, y, z, time) .* obj.hx(x, y, time) - ...
                obj.h(x, y, time) .* obj.Oux(x, y, z, time) + ...
                obj.Ov2d(x, y, z, time) .* obj.hy(x, y, time) + ...
                obj.OH(x, y, z, time) .* obj.v2dy(x, y, time) - ...
                obj.Ov(x, y, z, time) .* obj.hy(x, y, time) - ...
                obj.h(x, y, time) .* obj.Ovy(x, y, z, time);
        end
