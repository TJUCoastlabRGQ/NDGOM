...
void ImposeDirichletBoundaryCondition(double *dest, double *InputRHS, mwIndex *irs, mwIndex *jcs, int LocalEle, \
	...
	FILE *fp;
	fp = fopen("D:\\Share with pc\\研究工作\\20210530\\K11PVPXnx.dat", "w");
	...
	FILE *fp1;
	fp1 = fopen("D:\\Share with pc\\研究工作\\20210530\\K13PVPZnx.dat", "w");
	for (int i = 0; i < Np*Np; i++){
		fprintf(fp1, "%f\n", TempContribution[i]);
	}
	fclose(fp1);
	...
	FILE *fp2;
	fp2 = fopen("D:\\Share with pc\\研究工作\\20210530\\K22PVPYny.dat", "w");
	for (int i = 0; i < Np*Np; i++){
		fprintf(fp2, "%f\n", TempContribution[i]);
	}
	fclose(fp2);
	...
	FILE *fp3;
	fp3 = fopen("D:\\Share with pc\\研究工作\\20210530\\K23PVPZny.dat", "w");
	for (int i = 0; i < Np*Np; i++){
		fprintf(fp3, "%f\n", TempContribution[i]);
	}
	fclose(fp3);
	...
	FILE *fp4;
	fp4 = fopen("D:\\Share with pc\\研究工作\\20210530\\K31PVPXnz.dat", "w");
	for (int i = 0; i < Np*Np; i++){
		fprintf(fp4, "%f\n", TempContribution[i]);
	}
	fclose(fp4);
	...
	FILE *fp5;
	fp5 = fopen("D:\\Share with pc\\研究工作\\20210530\\K32PVPYnz.dat", "w");
	for (int i = 0; i < Np*Np; i++){
		fprintf(fp5, "%f\n", TempContribution[i]);
	}
	fclose(fp5);
	...
	FILE *fp6;
	fp6 = fopen("D:\\Share with pc\\研究工作\\20210530\\K33PVPZnz.dat", "w");
	for (int i = 0; i < Np*Np; i++){
		fprintf(fp6, "%f\n", TempContribution[i]);
	}
	fclose(fp6);
	...
	FILE *fp7;
	fp7 = fopen("D:\\Share with pc\\研究工作\\20210530\\PenaltyPart.dat", "w");
	for (int i = 0; i < Np*Np; i++){
		fprintf(fp7, "%f\n", TempContribution[i]);
	}
	fclose(fp7);
	...
	FILE *fp8;
	fp8 = fopen("D:\\Share with pc\\研究工作\\20210530\\FinalData.dat", "w");
	for (int i = 0; i < Np*Np; i++){
		fprintf(fp8, "%f\n", Contribution[i]);
	}
	fclose(fp8);
