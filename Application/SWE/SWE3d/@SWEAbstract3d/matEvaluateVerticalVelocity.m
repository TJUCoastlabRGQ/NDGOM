...
dHUdx = mesh3d.rx .* ( mesh3d.cell.Dr * fphys3d(:, :, 1) ) + mesh3d.sx .* ( mesh3d.cell.Ds * fphys3d(:, :, 1) );
dHVdy = mesh3d.ry .* ( mesh3d.cell.Dr * fphys3d(:, :, 2) ) + mesh3d.sy .* ( mesh3d.cell.Ds * fphys3d(:, :, 2) );
