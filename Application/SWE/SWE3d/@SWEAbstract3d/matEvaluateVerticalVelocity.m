...
data2d = cell(1);
data2d{1}(:,:,1) = mesh3d.Extend2dField( fphys2d(:, :, 2) );
data2d{1}(:,:,2) = mesh3d.Extend2dField( fphys2d(:, :, 3) );
[ dHU2Ddx, dHV2Ddy ] = obj.matEvaluateDepthAveragedHorizontalPartialDerivativeTerm(mesh3d, data2d); 
