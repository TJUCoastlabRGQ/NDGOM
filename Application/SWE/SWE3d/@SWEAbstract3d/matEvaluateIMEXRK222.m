...
%       dt = 0.1;
    ...
    for intRK = 1:2
        ...
        [ImplicitRHS3d(:,:,intRK), ImplicitRHS3d(:,:,intRK+2), fphys{1}(:,:,1), fphys{1}(:,:,2)] = ...
            matUpdateImplicitVerticalDiffusion(SystemRHS, DiffusionCoefficient, obj.meshUnion(1), obj.mesh2d(1),...
            fphys{1},IMa(intRK,intRK), dt, obj.Cf{1}, obj.WindTaux{1}, obj.WindTauy{1});
