...
srcfile = {[path,'mxFirstOrderDerivAboutNohydroPressInVert.c'],...
    [path,'mxSecondOrderDerivAboutNohydroPressInVert.c'],...
    [path,'mxSecondOrderDerivAboutNohydroPressInHorizon.c'],...
    [path,'mxMixedSecondOrderDerivAboutNonhydroStaticPressureUpdated.c'],...
    [path,'mxAssembleNonhydroRHS.c'],...
    [path,'mxUpdateConservativeFinalVelocity.c'],...
    [path,'mxCalculatePartialDerivative.c'],...
    [path,'mxAssembleGlobalStiffMatrix.c'],...
    [path,'mxUpdateVerticalFinalVelocity.c'],...
    [path,'mxMixedSecondOrderDerivAboutNonhydroStaticPressureUpdatedNew.c'],...
    [path,'mxMixedSecondOrderDerivAboutNonhydroStaticPressureUpdatedNewVer.c']};
...
path = 'Application/SWE/SWE3d/UnitTest/@EllipticProblemInHorizontalDirectionTest3d/private/';
