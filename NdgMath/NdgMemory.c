...
void GotmSolverMemoryAllocation( int Interface, int Np2d, int K3d, int K2d ){
	tkeGOTM = malloc(sizeof(double)*(K2d*Np2d*Interface)); 
    MemoryAllocationCheck(tkeGOTM, sizeof(double)*(K2d*Np2d*Interface));
	epsGOTM = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(epsGOTM, sizeof(double)*(K2d*Np2d*Interface));
	LGOTM = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(LGOTM, sizeof(double)*(K2d*Np2d*Interface));
	nuhGOTM = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(nuhGOTM, sizeof(double)*(K2d*Np2d*Interface));
	numGOTM = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(numGOTM, sizeof(double)*(K2d*Np2d*Interface));
	layerHeight = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(layerHeight, sizeof(double)*(K2d*Np2d*Interface));
	huCentralDate = malloc(sizeof(double)*(K3d*Np2d));
    MemoryAllocationCheck(huCentralDate, sizeof(double)*(K3d*Np2d));
	huCentralDateNew = malloc(sizeof(double)*(K3d*Np2d));
	MemoryAllocationCheck(huCentralDateNew, sizeof(double)*(K3d*Np2d));
	hvCentralDate = malloc(sizeof(double)*(K3d*Np2d));
    MemoryAllocationCheck(hvCentralDate, sizeof(double)*(K3d*Np2d));
	hvCentralDateNew = malloc(sizeof(double)*(K3d*Np2d));
	MemoryAllocationCheck(hvCentralDateNew, sizeof(double)*(K3d*Np2d));
	//The space occupied by the first data in huVerticalLine is not used
	huVerticalLine = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(huVerticalLine, sizeof(double)*(K2d*Np2d*Interface));
	huVerticalLineNew = malloc(sizeof(double)*(K2d*Np2d*Interface));
	MemoryAllocationCheck(huVerticalLineNew, sizeof(double)*(K2d*Np2d*Interface));
	hvVerticalLine = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(hvVerticalLine, sizeof(double)*(K2d*Np2d*Interface));
	hvVerticalLineNew = malloc(sizeof(double)*(K2d*Np2d*Interface));
	MemoryAllocationCheck(hvVerticalLineNew, sizeof(double)*(K2d*Np2d*Interface));
	shearFrequencyDate = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(shearFrequencyDate, sizeof(double)*(K2d*Np2d*Interface));
	buoyanceFrequencyDate = malloc(sizeof(double)*(K2d*Np2d*Interface));
    MemoryAllocationCheck(buoyanceFrequencyDate, sizeof(double)*(K2d*Np2d*Interface));
	BottomFrictionLength = malloc(sizeof(double)*K2d*Np2d);
    MemoryAllocationCheck(BottomFrictionLength, sizeof(double)*K2d*Np2d);
	BottomFrictionVelocity = malloc(sizeof(double)*K2d*Np2d);
    MemoryAllocationCheck(BottomFrictionVelocity, sizeof(double)*K2d*Np2d);
	SurfaceFrictionLength = malloc(sizeof(double)*K2d*Np2d);
    MemoryAllocationCheck(SurfaceFrictionLength, sizeof(double)*K2d*Np2d);
	SurfaceFrictionVelocity = malloc(sizeof(double)*K2d*Np2d);
    MemoryAllocationCheck(SurfaceFrictionVelocity, sizeof(double)*K2d*Np2d);
	eddyViscosityDate = malloc(sizeof(double)*(K2d*Np2d * Interface));
    MemoryAllocationCheck(eddyViscosityDate, sizeof(double)*(K2d*Np2d * Interface));
	rhoCentralDate = malloc(sizeof(double)*(K3d*Np2d));
	MemoryAllocationCheck(rhoCentralDate, sizeof(double)*(K3d*Np2d));
	rhoVerticalLine = malloc(sizeof(double)*(K2d*Np2d*Interface));
	MemoryAllocationCheck(rhoVerticalLine, sizeof(double)*(K2d*Np2d*Interface));
	...
	*/
	hcenter = malloc(K2d *Np2d* sizeof(double));
	MemoryAllocationCheck(hcenter, sizeof(double)*K2d*Np2d);
	hTCentralData = malloc(K3d *Np2d* sizeof(double));
	hSCentralData = malloc(K3d *Np2d* sizeof(double));
	hTVerticalLine = malloc(sizeof(double)*(K2d*Np2d*Interface));
	hSVerticalLine = malloc(sizeof(double)*(K2d*Np2d*Interface));
