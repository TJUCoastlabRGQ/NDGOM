...
% % tic;
            physClass.frhs{1}(:,:,1:2) = mxEvaluateHorizontalDiffRHS(physClass.hcrit, int8(physClass.meshUnion.type),...
              obj.Prantl, obj.InnerEdge, obj.BoundaryEdge, obj.nv, physClass.frhs{1}(:,:,1:2), fphys,  physClass.varFieldIndex([1,2]),...
