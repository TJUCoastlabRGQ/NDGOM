...
% [fphys(:,:,[1,2]), physClass.ImplicitRHS(:,:,RKIndex:(IMStage-1):end)] = mxSparseVersionUpdateImplicitRHS(...
%     physClass.meshUnion(1).mesh2d(1).J, physClass.meshUnion(1).J, physClass.meshUnion(1).mesh2d(1).cell.M,...
%     physClass.meshUnion(1).cell.M, physClass.meshUnion(1).tz, physClass.meshUnion(1).cell.Dt, ...
...
%     physClass.meshUnion(1).cell.Nface, obj.BoundaryEdgeType, huv3d, Height2d, physClass.hcrit, ...
%     physClass.meshUnion(1).cell.VCV, physClass.Cf{1}, obj.BotBoundaryTreatType, obj.f0 );

[fphys(:,:,[1,2,3]), ~] = mxSparseVersionUpdateImplicitRHS(...
    physClass.meshUnion(1).mesh2d(1).J, physClass.meshUnion(1).J, physClass.meshUnion(1).mesh2d(1).cell.M,...
    physClass.meshUnion(1).cell.M, physClass.meshUnion(1).tz, physClass.meshUnion(1).cell.Dt, ...
    DiffusionCoefficient, physClass.SurfBoundNewmannDate(:,:,[1,2,3]), physClass.BotBoundNewmannDate(:,:,[1,2,3]),...
    dt, ImplicitParameter, SystemRHS(:,:,[1,2,3]), physClass.Prantl, UpEidM, BottomEidM, max(physClass.meshUnion(1).cell.N, physClass.meshUnion.cell.Nz),...
    physClass.meshUnion(1).cell.Nface, obj.BoundaryEdgeType, huv3d, Height2d, physClass.hcrit, ...
    physClass.meshUnion(1).cell.VCV, physClass.Cf{1}, obj.BotBoundaryTreatType, obj.f0, obj.NonhydroType,...
    physClass.fphys2d{1}(:,:,5), physClass.fphys2d{1}(:,:,6) );
