function [ LDGqx, LDGqy ] = matAlternatingDownwindLDGFlux( obj, mesh, BoundaryEdge, InnerEdge, Variable, ftype)
...
fluxSX = InnerEdge.nx.*fp;fluxSY = InnerEdge.ny.*fp;
...
fluxSX = BoundaryEdge.nx.*fp;fluxSY = BoundaryEdge.ny.*fp;
