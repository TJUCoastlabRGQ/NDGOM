function  [nx, ny, Js] = matGetElementFaceNormalDirectionVector( obj, ele, adjacentEle,...
...
%> @param[out] Js The facial Jacobian of the studied edge
    [nx, ny, Js] = mxGetElementFaceNormalDirectionVector( ele, adjacentEle, face,  BoundaryEdgeFToF, BoundaryEdgenx, BoundaryEdgeny,...
        BoundaryEdgeFToE, InnerEdgenx, InnerEdgeny, InnerEdgeFToE, BoundaryEdgeJs, InnerEdgeJs );
end