...
% [tempqx, tempqy] = obj.matCalculateLDGAuxialaryTerm( mesh, BoundaryEdge, InnerEdge, num2cell(gmat,[1 2]));
...
for i = 1:numel(Row)
    % The current cell is the adjacent cell, ie, all the value
    % corresponding to the current cell is the so-called Fp
    if Row(i) == 2
