...
hv_norm = InnerEdge.ny .* hvm;
sign_hv_norm = sign(hv_norm);
fluxNHy = InnerEdge.ny .* (hm.*(sign_hv_norm+1)*0.5 + hp.*(1 - sign_hv_norm)*0.5) .* sign_hv_norm;
fluxNHuy = InnerEdge.ny .* (hum.*(sign_hv_norm+1)*0.5 + hup.*(1 - sign_hv_norm)*0.5) .* sign_hv_norm;
fluxNHvy = InnerEdge.ny .* (hvm.*(sign_hv_norm+1)*0.5 + hvp.*(1 - sign_hv_norm)*0.5) .* sign_hv_norm;
...
hv_norm = BoundaryEdge.ny .* hvm;
sign_hv_norm = sign(hv_norm);
fluxNHy = BoundaryEdge.ny .* (hm.*(sign_hv_norm+1)*0.5 + hp.*(1 - sign_hv_norm)*0.5) .* sign_hv_norm;
fluxNHuy = BoundaryEdge.ny .* (hum.*(sign_hv_norm+1)*0.5 + hup.*(1 - sign_hv_norm)*0.5) .* sign_hv_norm;
fluxNHvy = BoundaryEdge.ny .* (hvm.*(sign_hv_norm+1)*0.5 + hvp.*(1 - sign_hv_norm)*0.5) .* sign_hv_norm;
