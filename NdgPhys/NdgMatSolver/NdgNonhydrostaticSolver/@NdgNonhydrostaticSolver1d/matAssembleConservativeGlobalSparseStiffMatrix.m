function StiffMatrix = matAssembleConservativeGlobalSparseStiffMatrix(obj, UpdatedPNPX, UpdatedSPNPX, fphys, PhysClass)
...
StiffMatrix = mxAssembleGlobalStiffMatrix(obj.dt, h, UpdatedSPNPX,  UpdatedPNPX, obj.fhx, ...
