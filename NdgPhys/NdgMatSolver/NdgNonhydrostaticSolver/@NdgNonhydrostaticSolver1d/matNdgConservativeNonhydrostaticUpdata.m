...
[UpdatedPNPX, UpdatedSPNPX]...
    = obj.matReconstructStiffmatrixRelatedMatrix( physClass);

obj.matAssemblePointToCellInformation(mesh.K, mesh.cell.Np, UpdatedPNPX, UpdatedSPNPX,...
    obj.NP);

obj.matCalculateFphysDerivative( mesh, fphys, physClass);

StiffMatrix = obj.matAssembleConservativeGlobalSparseStiffMatrix(UpdatedPNPX, UpdatedSPNPX,...
     fphys, physClass);
