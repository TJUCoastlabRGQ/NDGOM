classdef NonhydroStaticSolver3dTest < SWEBarotropic3d
    ...
    methods
        ...
        function matNonhydrostaticSolver3dTest( obj )
            obj.matPartialDeriveTermTest( );
            
            obj.matAssembleRightHandSideTest( );
            
            obj.matAssembleGlobalStiffMatrixTest( );
            
            obj.matConservativeVelocityUpdataTest( );
        end
        ...
        matPartialDeriveTermTest( obj );
        
        matAssembleRightHandSideTest( obj );
        
        matAssembleGlobalStiffMatrixTest( obj );
