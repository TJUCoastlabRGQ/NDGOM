function  [qx, qy, q2x, q2y, qbx, qby, fqbx, fqby, Nonhydrop] = matAssembleCharacteristicMatrix(obj, mesh, index)
...
[ tempqx, tempqy ]  = getAuxialiaryVariable( obj, mesh, BoundaryEdge, InnerEdge, num2cell(gmat,[1 2]));
...
% [ tempq2x, tempq2y ] = getSecondOrderTerm( obj, mesh, BoundaryEdge, InnerEdge, num2cell(gmat,[1 2]), num2cell(tempqx,[1 2]), num2cell(tempqy,[1 2]) );
