...
* 		double[nfp x Ne]  variableym local variable in y direction, used together with ny to determine the flux in y direction when the flux direction is outward
* 		double[nfp x Ne]  variableyp adjacent variable in y direction, used together with ny to determine the flux in y direction when the flux direction is inward 
...
* 		double[nfp x Ne] 	UpwindFluxY the upwind flux term in y direction 
*/
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
    ...
    double *UpwindFluxY = mxGetPr(plhs[1]);
