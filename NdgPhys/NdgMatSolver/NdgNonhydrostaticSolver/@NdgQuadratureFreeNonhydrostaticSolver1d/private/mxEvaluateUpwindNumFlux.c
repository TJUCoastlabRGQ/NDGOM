...
*       double[nfp x Ne]  hum  local flux term in x direction, used together with variables hup to determine the upwind direction
* 		double[nfp x Ne]  hup  adjacent flux term in x direction, used together with variables hum to determine the upwind direction
