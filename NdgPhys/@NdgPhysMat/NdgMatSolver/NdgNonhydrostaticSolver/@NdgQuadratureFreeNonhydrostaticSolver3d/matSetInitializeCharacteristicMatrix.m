...
obj.SPNPX = mxSecondOrderDerivAboutNohydroPressInHorizon( meshUnion.cell.Np,...
        ...
        meshUnion.J, meshUnion.InnerEdge.Js, meshUnion.cell.M,...
        ...
        meshUnion.SurfaceBoundaryEdge.Js, EdgeType); 
...
obj.MSPNPX = mxMixedSecondOrderDerivAboutNonhydroStaticPressureUpdatedNew(meshUnion.cell.Np,...
    meshUnion.K, meshUnion.Nz, meshUnion.mesh2d.K, meshUnion.cell.Nface,...
    meshUnion.EToE, meshUnion.InnerEdge.FToE, meshUnion.InnerEdge.FToF,...
    meshUnion.InnerEdge.FToN1, meshUnion.InnerEdge.FToN2, meshUnion.LAV, ...
...
obj.MSPNPY = mxMixedSecondOrderDerivAboutNonhydroStaticPressureUpdatedNew(meshUnion.cell.Np,...
    meshUnion.K, meshUnion.Nz, meshUnion.mesh2d.K, meshUnion.cell.Nface,...
    meshUnion.EToE, meshUnion.InnerEdge.FToE, meshUnion.InnerEdge.FToF,...
    meshUnion.InnerEdge.FToN1, meshUnion.InnerEdge.FToN2, meshUnion.LAV,...
    meshUnion.J, meshUnion.mesh2d.J, meshUnion.InnerEdge.Js,...
