function  [ fluxX, fluxY ] = matEvaluateUpwindNumFlux( obj, status, EdgeFToE, HUm, HVm, HUp, HVp, vfmx, vfpx, vfmy, vfpy, Edgenx, Edgeny)
...
[ fluxX, fluxY ] = mxEvaluateUpwindNumFlux( status, EdgeFToE, HUm, HVm, HUp, HVp, vfmx, vfpx, vfmy, vfpy, Edgenx, Edgeny);
end