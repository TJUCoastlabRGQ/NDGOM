function  [qx, SecondOrderTerm ] = matAssembleCharacteristicMatrix(obj, mesh, ele, edgeType)
...
%     adjacentrows = ((adjacentEle-1)*Np+1:adjacentEle*Np)'*ones(1,Np);
    ...
    [nx, Js] = obj.matGetElementFaceNormalDirectionVector( ele, adjacentEle, face,  mesh.BoundaryEdge.FToF, mesh.BoundaryEdge.nx,...
        mesh.BoundaryEdge.FToE, mesh.InnerEdge.nx, mesh.InnerEdge.FToE, mesh.BoundaryEdge.Js, mesh.InnerEdge.Js );
    Dx2 = diag(mesh.rx(:,adjacentEle))*mesh.cell.Dr;
