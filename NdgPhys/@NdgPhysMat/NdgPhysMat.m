    ...
    methods( Access = protected )
        ...
        function matEvaluateTemporalDiscrete( obj )            
            switch obj.getOption('temporalDiscreteType')
                ...
                case enumTemporalDiscrete.ARK232 %This is implemented for barotropic swe3d only 
                    obj.matEvaluateARK232(); 
                otherwise
        ...
        function matUpdateFinalResult( obj, time, fphys )
            for m = 1:obj.Nmesh
                ...
                obj.outputFile(m).closeOutputFile(obj.outputFile(m).fileOrder); %This function name can be changed again
            end
        end% function
    end
end
